...
import { 
  ...
  Clock, CheckCircle, Smartphone, UserPlus, Headset, MessageCircle, Send, Megaphone, Users
} from "lucide-react";
    ...
    <div className="flex flex-col flex-1 pb-24">
          ...
          <>
            ...
            {activeTab === "profile" && (
              <div className="space-y-5">
                ...
                <div className="space-y-3">
                  <h4 className="text-[10px] font-black text-[#8c6239] uppercase tracking-widest pl-1 font-display">
                    Community & Support
                  </h4>
                  <div className="bg-white rounded-2xl border border-[#8c6239]/10 overflow-hidden shadow-sm">
                    {/* Community */}
                    <a
                      href="https://t.me/kudagridofficial"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-between p-4 hover:bg-[#faf7f2] transition-colors border-b border-[#faf7f2] group"
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-bold text-[#3d2314]">Community</p>
                          <p className="text-[10px] text-[#8c6239]">Official Telegram Channel</p>
                        </div>
                      </div>
                      <ChevronRight className="w-4 h-4 text-[#8c6239]/40 group-hover:text-[#8c6239] transition-colors" />
                    </a>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-bold text-[#3d2314]">Group</p>
                          <p className="text-[10px] text-[#8c6239]">Join the discussion group</p>
                        </div>
                      </div>
                      <ChevronRight className="w-4 h-4 text-[#8c6239]/40 group-hover:text-[#8c6239] transition-colors" />
                    </a>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-bold text-[#3d2314]">Chat</p>
                          <p className="text-[10px] text-[#8c6239]">Support & General Chat</p>
                        </div>
                      </div>
                      <ChevronRight className="w-4 h-4 text-[#8c6239]/40 group-hover:text-[#8c6239] transition-colors" />
                    </a>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-bold text-[#3d2314]">Customer Service</p>
                          <p className="text-[10px] text-[#25D366] font-bold">WhatsApp Support</p>
                        </div>
                      </div>
                      <ChevronRight className="w-4 h-4 text-[#8c6239]/40 group-hover:text-[#8c6239] transition-colors" />
                    </a>
      ...
      >
        <motion.a
          ...
          className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center text-white shadow-lg shadow-[#25D366]/30 transition-transform active:scale-90 cursor-pointer"
        >
