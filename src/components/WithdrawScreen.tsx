    ...
    <div className="flex flex-col flex-1 bg-white overflow-hidden relative h-full font-sans">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-12 space-y-8 custom-scrollbar">
        ...
        {activeWallet === "commission" ? (
          ...
          <div className="p-12 rounded-[40px] bg-slate-50 border border-slate-100 text-center space-y-6">
            <div className="w-20 h-20 rounded-3xl bg-white border border-slate-100 shadow-sm text-red-500 flex items-center justify-center mx-auto">
              <Lock className="w-10 h-10" />
            </div>
            <div className="space-y-2">
              <h4 className="text-base font-bold text-slate-900">Portal Maintenance</h4>
              <p className="text-xs text-slate-500 font-medium leading-relaxed max-w-[200px] mx-auto">Referral withdrawals are temporarily closed for maintenance. Please check back later.</p>
            </div>
          </div>
        )}
